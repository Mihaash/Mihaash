...
> Real-time web dashboard that collects and visualizes malicious URL data from live threat feeds.

**Features:**
- Collects malicious URLs from online sources
- Auto-refreshes threat data every 60 seconds
- Live threat indicators with a clean web interface
- Assists in detecting and blocking harmful websites
...
🔗 [GitHub Repository](https://github.com/Mihaash/threat-inteldashboard)

---

### 2. Portfolio CI/CD Deployment
> Fully automated DevOps pipeline that builds and deploys a personal portfolio website — zero manual intervention required.

**Features:**
- Auto-triggers build on every code push
- Jenkins pipeline manages full CI workflow
...
🔗 [GitHub Repository](https://github.com/Mihaash/Devops-project)
...
**Features:**
- YARA-based signature detection for identifying known malware
- CAPA integration to uncover malware capabilities and behaviors
...
![AWS Secrets Manager](https://img.shields.io/badge/AWS_Secrets_Manager-DD344C?style=flat-square&logo=amazonaws&logoColor=white)
...
![OWASP_ZAP](https://img.shields.io/badge/OWASP_ZAP-00549E?style=flat-square&logo=owasp&logoColor=white)
![Checkov](https://img.shields.io/badge/Checkov-000000?style=flat-square&logo=bridgecrew&logoColor=white)
![Hadolint](https://img.shields.io/badge/Hadolint-000000?style=flat-square&logo=docker&logoColor=white)
![Bandit](https://img.shields.io/badge/Bandit-FF0000?style=flat-square&logo=python&logoColor=white)
![SonarQube](https://img.shields.io/badge/SonarQube-4E9BCD?style=flat-square&logo=sonarqube&logoColor=white)
![OWASP Dependency Check](https://img.shields.io/badge/OWASP_Dependency_Check-000000?style=flat-square&logo=owasp&logoColor=white)
![OPA](https://img.shields.io/badge/Open_Policy_Agent-7D32A8?style=flat-square&logo=openpolicyagent&logoColor=white)
...
![VAPT](https://img.shields.io/badge/VAPT-E11D48?style=flat-square&logo=hackthebox&logoColor=white)
![TryHackMe](https://img.shields.io/badge/TryHackMe-212C42?style=flat-square&logo=tryhackme&logoColor=white)
![CTF](https://img.shields.io/badge/CTF_Practice-7C3AED?style=flat-square&logo=hackthebox&logoColor=white)
---
